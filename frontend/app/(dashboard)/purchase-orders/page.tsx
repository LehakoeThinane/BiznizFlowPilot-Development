              ...
              <div className="border-t border-outline-variant pt-5">
                ...
                <div className="flex gap-3 items-center">
                  <select
                    ...
                    className="flex-1 rounded-md border border-outline-variant px-3 py-2 text-sm bg-background text-white focus:outline-none focus:ring-2 focus:ring-brand/50 capitalize"
                  >
