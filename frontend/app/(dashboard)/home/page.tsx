...
const SECTIONS: Section[] = [
  {
    ...
    apps: [
      {
        title: "Finance",
        description: "Ledgers, invoicing, payroll, and liquidity tracking in one hub.",
        href: "/finance",
        icon: "payments",
      ...
      {
        title: "HR",
        description: "Headcount, leave, recruitment, and performance in one hub.",
        href: "/employees",
        icon: "groups",
  ...
  },
  {
    ...
    apps: [
      ...
      {
        title: "Purchasing",
        description: "Purchase orders and requisitions in one procurement hub.",
  ...
  },
  {
    ...
    apps: [
      {
        title: "Inventory",
        description: "Stock levels, product catalog, and supplier directory in one hub.",
        href: "/inventory",
        icon: "warehouse",
